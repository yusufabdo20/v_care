...
extension NavigationExtension on BuildContext {
  ...
  Future<T?> pushReplacement<T extends Object, TO extends Object>(Widget newRoute) {
    return Navigator.pushReplacement<T, TO>(this, MaterialPageRoute(builder: (context) => newRoute));
  }
